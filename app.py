...
def screen_stocks():
    ...
    def analyze_one(item):
        ...
        return {
            ...
            "turnover_rate": sf(details.get("turnover_rate")),
            ...
            "foreign_consec": details.get("foreign_consec", 0),
            "trust_consec": details.get("trust_consec", 0),
            "foreign_cum_5d": sf(details.get("foreign_cum_5d", 0)),
            "trust_cum_5d": sf(details.get("trust_cum_5d", 0)),
            "margin_balance": sf(details.get("margin_balance", 0)),
            "margin_change": sf(details.get("margin_change", 0)),
            "short_balance": sf(details.get("short_balance", 0)),
            "matched": matched,
